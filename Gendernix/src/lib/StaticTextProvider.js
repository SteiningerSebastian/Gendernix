export class StaticTextProvider {
 ...
 Die Menge des Kaffeepulvers hängt von seinem persönlichen Geschmack und der Kaffeestärke ab. Eine allgemeine Empfehlung ist, etwa 1 bis 2 Esslöffel Kaffeepulver pro Tasse zu verwenden. Das Kaffeepulver wird in den Filter gegeben, und es ist wichtig, es gleichmäßig zu verteilen, um eine gleichmäßige Extraktion zu gewährleisten.
 Sobald der Benutzer alles vorbereitet hat, steckt er den Stecker des Kaffeeautomaten in die Steckdose und schaltet ihn ein. Die Maschine beginnt nun damit, das Wasser auf die optimale Brühtemperatur zu heizen. Dies kann einige Minuten dauern, je nach Modell und Wassermenge.
 Während der Kaffeeautomat arbeitet, sollte der Benutzer darauf achten, sich nicht zu verbrennen, da der Kaffee sehr heiß ist. Er kann die Kanne verwenden, um den Kaffee in seine Tasse zu gießen, und den frisch gebrühten Kaffee genießen.
 ...
 Die Absatzformatierung erlaubt es dem Anwender, Absätze hinzuzufügen und die Ausrichtung des Textes zu bestimmen. Möglichkeiten hierbei sind linksbündig, zentriert oder rechtsbündig. Listen oder Aufzählungen sind einfach zu erstellen, indem der Anwender den betreffenden Text auswählt und die entsprechende Option in der Symbolleiste nutzt.
 Wenn Bilder in das Dokument eingefügt werden sollen, kann der Anwender auf "Einfügen" klicken und "Bild" auswählen. Das gewünschte Bild wird dann ausgewählt und ins Dokument eingefügt.
 Das regelmäßige Speichern des Dokuments ist wichtig, um Datenverlust zu vermeiden. Dazu klickt man auf "Datei" und "Speichern" und legt Speicherort und Dateinamen fest.
 Für den Druck des Dokuments wählt der Nutzer erneut "Datei" und "Drucken". Dabei ist darauf zu achten, den richtigen Printer auszuwählen und die Druckeinstellungen anzupassen, falls notwendig.
 ...
 Die Zellen können formatiert werden, indem die Formatierungsoptionen genutzt werden. Hierbei stehen Schriftart, Schriftgröße, Fett, Kursiv und Hervorhebung von Text zur Verfügung.
 Tabellen können erstellt und bearbeitet werden, indem Daten in mehreren Zellen ausgewählt und dann auf "Tabelle" geklickt wird. Zeilen und Spalten können hinzugefügt oder gelöscht werden.
 Formeln sind nützlich, um Berechnungen durchzuführen. Jeder kann eine Zelle mit "=" beginnen, gefolgt von der gewünschten Formel.
 Diagramme können erstellt werden, um Daten grafisch darzustellen. Dies erfolgt, indem die relevanten Daten markiert und auf "Diagramm erstellen" geklickt wird.
 Das regelmäßige Speichern des Arbeitsblatts ist wichtig, um Datenverlust zu vermeiden. Dies erfolgt durch Klicken auf "Datei" und "Speichern" sowie das Festlegen des Speicherorts und Dateinamens. Für den Druck des Arbeitsblatts wählt der Nutzer erneut "Datei" und "Drucken". Dabei ist darauf zu achten, den richtigen Printer auszuwählen und die Druckeinstellungen anzupassen.
